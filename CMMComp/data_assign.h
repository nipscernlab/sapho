...
void var_set     (int id, int et , int is_array, int set_type, int pop, int warn); // funcao principal de atribuicao de variaveis (SET)
...
void   var_set_comp (int id, int  et  , int is_array, int set_type); // atribuicao com variaveis complexas
// fim do teste ---------------------------------------------------------------
